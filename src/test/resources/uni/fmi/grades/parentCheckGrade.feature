   ...
   Scenario Outline: Parent check grade for a certain student and subject
    ...
    And clicks submit button
	   Then show message: "<message>"
		...
		| 1901321104     | 	Java			|  You haven't permission to get this user grade		|
		| 1901321102     | 	Java			|  Student doesn't exist	 							|
		| 1901321105     | 	Ftas			|  Subject doesn't exist   								|
		| 1901321105     | 	C#				|  The student does not have a grade in this subject    |
